...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['save_blog_section'])) {
        ...
        header('Location: ' . $GLOBALS['site_url'] . 'blogs/blog_details_page');
        exit();
    }
}
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="min-height: 107px;">
            <div class="card card-primary card-body">
                ...
                <div class="card-header">Blog Details Page</div>
                <form action="<?php echo htmlspecialchars($GLOBALS["site_url"]); ?>blogs/blog_details_page" method="post">
                    <div class="card card-primary card-body">
