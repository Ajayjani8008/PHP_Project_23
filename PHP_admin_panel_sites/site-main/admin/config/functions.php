...
$GLOBALS['site_url'] = "http://localhost/site/admin/";
$GLOBALS['main_site_url'] = "http://localhost/site/";
$GLOBALS['new_site_url'] = "http://localhost/site/";
$GLOBALS['uploads_dir_root'] = "C:/xampp/htdocs/site/admin/";
